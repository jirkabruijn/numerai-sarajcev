...
X_train_second, X_validate, y_train_second, y_validate = model_selection.train_test_split(proba_all.values, y_test,
...
# Select classifier outputs
print("# Select classifier outputs")
'''
...
ws3 = []  # weights (ws = [3, 4, 2, 1, 1, 1, 2, 3, 1, 2]  # weights (10))
...
header("# with Keras Network (Merged branches)")
...
header("# Weighted Average of stackings")
...
header("# Using Weighted Average of predictions")
...
y_proba_predicted = np.average(proba_all_new, axis=1, weights=ws3)
print("# y_proba_predicted.shape:")
print(y_proba_predicted.shape)
